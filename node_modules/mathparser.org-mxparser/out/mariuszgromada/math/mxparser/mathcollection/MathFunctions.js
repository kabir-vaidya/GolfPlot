...
const bignumber_1 = require("bignumber.js/bignumber");
/**
...
class MathFunctions {
    ...
    static plus(a, b) {
        ...
        if ( /* isInfinite */((value) => Number.NEGATIVE_INFINITY === value || Number.POSITIVE_INFINITY === value)(b))
            return a + b;
        const da = new bignumber_1.BigNumber(a);
        const db = new bignumber_1.BigNumber(b);
    ...
    static div(a, b) {
        ...
        const da = new bignumber_1.BigNumber(a);
        const db = new bignumber_1.BigNumber(b);
        return da.dividedBy(db).decimalPlaces(34, bignumber_1.BigNumber.ROUND_HALF_UP).toNumber();
    }
    ...
    /*private*/ static powInt(a, n) {
        ...
        if (mXparserConstants_1.mXparserConstants.checkIfCanonicalRounding()) {
            ...
            if (n >= 0)
                ...
                return new bignumber_1.BigNumber(1).dividedBy(da).decimalPlaces(34, bignumber_1.BigNumber.ROUND_HALF_UP).pow(-n).toNumber();
        }
        else {
            return Math.pow(a, n);
        }
    ...
    static coth(a) {
        if ( /* isNaN */isNaN(a))
            return j4ts_1.javaemul.internal.DoubleHelper.NaN;
        let result = j4ts_1.javaemul.internal.DoubleHelper.NaN;
        const tanh = (x => { if (x == Number.POSITIVE_INFINITY) {
            return 1;
        }
        else if (x == Number.NEGATIVE_INFINITY) {
            return -1;
    ...
    static sech(a) {
        if ( /* isNaN */isNaN(a))
            return j4ts_1.javaemul.internal.DoubleHelper.NaN;
        let result = j4ts_1.javaemul.internal.DoubleHelper.NaN;
        const cosh = (x => (Math.exp(x) + Math.exp(-x)) / 2)(a);
        if (cosh !== 0)
            result = 1.0 / cosh;
        return result;
    }
    ...
    static csch(a) {
        if ( /* isNaN */isNaN(a))
            return j4ts_1.javaemul.internal.DoubleHelper.NaN;
        let result = j4ts_1.javaemul.internal.DoubleHelper.NaN;
        const sinh = (x => (Math.exp(x) - Math.exp(-x)) / 2)(a);
        if (sinh !== 0)
            result = 1.0 / sinh;
        return result;
    }
    ...
    static round(value, places) {
        ...
        if (places < 0)
            return j4ts_1.javaemul.internal.DoubleHelper.NaN;
        let bd = new bignumber_1.BigNumber(/* toString */ ('' + (value)));
        bd = bd.decimalPlaces(places, bignumber_1.BigNumber.ROUND_HALF_UP);
        return bd.toNumber();
    }
    /**
